...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "malvin~Zz8UnRzD#UyNK6IFzzCjeWXdfAOhD4u5W-OX1JSx64HXR_ZUBKLg",
// add your Session Id make sure it starts with malvin~
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "~BTD NUELLA~",
...
// make true if you want auto reply on status 
        ...
        AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY ~𝕯𝖆𝖗𝖐 𝕬𝖓𝖌𝖊𝖑🥰🌹~*",
...
// add alive msg here 
        ...
        STICKER_NAME: process.env.STICKER_NAME || "𝕯𝖆𝖗𝖐𝕬𝖓𝖌𝖊𝖑",
...
OWNER_NAME: process.env.OWNER_NAME || "~𝕯𝖆𝖗𝖐 𝕬𝖓𝖌𝖊𝖑🥰🌹~",
// add bot owner name
...
// true if want mark commands as read 
     ...
     DEV: process.env.DEV || "2348140014951",
